...
function SearchLeftOption () {
  ...
  const loadChemicalListbysmiles = async (value) => {
    ...
    console.log(value)
    setList([])
    const response = await fetch(`https://oadb-web-server.onrender.com:5000/structurequery/${value}`)
  ...
  const loadChemicalListbycasno = async (value) => {
    ...
    console.log(value)
    setList([])
    const response = await fetch(`https://oadb-web-server.onrender.com:5000/casnoquery/${value}`)
    const jsonData = await response.json()
    console.log(jsonData)
    // console.log(list)
    // console.log(value)
  ...
  const loadChemicalListbyassayname = async (value) => {
    ...
    console.log(value)
    setList([])
    const response = await fetch(`https://oadb-web-server.onrender.com:5000/assaynamequery/${value}`)
    const jsonData = await response.json()
    console.log(jsonData)
    // console.log(list)
    // console.log(value)
  ...
  const loadChemicalListbyactivitydata = async (value) => {
    ...
    const response = await fetch(`https://oadb-web-server.onrender.com:5000/activitydataquery?minvalue=${minval}&maxvalue=${maxval}`)
  ...
  const loadChemicalListbyname = async (value) => {
    ...
    console.log(value)
    setList([])
    const response = await fetch(`https://oadb-web-server.onrender.com:5000/mastertableinfo/${value}`)
    const jsonData = await response.json()
    setList(jsonData)
    console.log(jsonData)
    // console.log(list)
